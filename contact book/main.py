...
root = Tk()
root.title("Varun Singh Contact Book")
root.geometry('700x550')
root.resizable(0, 0)

# Creating the color and font variables
lf_bg = '#EEE8CD'  # Lightest Shade
cf_bg = '#CDC8B1'
rf_bg = '#FFF8DC'  # Darkest Shade
frame_font=Gray35t = ("Garamond", 14)
...
listbox = Listbox(right_frame, selectbackground='SkyBlue', bg='#FFFAF0', font=('Helvetica', 12), height=20, width=25)
